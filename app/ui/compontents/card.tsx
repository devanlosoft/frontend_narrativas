...
export default function Card({ imageUrl, title, description, buttonUrl }: any) {


  return (
    <div
      className="relative flex h-full items-center justify-start overflow-hidden bg-cover bg-center "
    ...
    >
      ...
      <div className="relative z-10 p-32 pl-32 text-left text-white">
        {/* Título */}
        <h2 className="text-5xl font-bold lg:text-7xl ">{title}</h2>

        {/* Descripción */}
        <p className="mb-4 mt-4 text-lg font-bold lg:text-2xl">{description}</p>
